...
void setup() {
  ...
  widget1 = new Widget(30, 678, 300, 40, "Raw Information", color(128, 128, 128), font, BUTTON1);
  widget2 = new Widget(335, 678, 300, 40, "Bar-Chart", color(128, 128, 128), font, BUTTON2);
  widget3 = new Widget(640, 678, 300, 40, "Pie-Chart", color(128, 128, 128), font, BUTTON3);
  widget4 = new Widget(945, 678, 300, 40, "Heat Map", color(128, 128, 128), font, BUTTON4);
